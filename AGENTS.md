# AGENTS.md — networking-components/networking-components-mcp-server.rs
...
- GitHub org: [`networking-components`](https://github.com/networking-components)
- Repository: [`networking-components/networking-components-mcp-server.rs`](https://github.com/networking-components/networking-components-mcp-server.rs)
- Local checkout: `~/codes/networking-components/networking-components-mcp-server.rs`
- Linear project: https://linear.app/denman/project/githubcomnetworking-components-0099b19507ec
- GitHub org project: https://github.com/orgs/networking-components/projects/1
- Sibling test org: `github.com/networking-components-test` (external/e2e coverage and extra GHA minutes)
...
- Package / service name: `networking-components-mcp-server`
