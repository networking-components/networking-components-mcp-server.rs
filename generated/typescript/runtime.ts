...
export function loadEnvMap(
  ...
  const out: Record<string, string> = {};
  const networking_components_mcp_server_bind = pick(["NETWORKING_COMPONENTS_MCP_SERVER_BIND"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, "127.0.0.1:9090");
  if (networking_components_mcp_server_bind !== undefined) out["NETWORKING_COMPONENTS_MCP_SERVER_BIND"] = networking_components_mcp_server_bind;
  return out;
}
